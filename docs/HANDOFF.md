...
운영자가 **다른 Claude 계정으로 로그인**하거나 **새 대화**를 열고 "사이트 작업 재개"라고 말했을 때, 새 Claude가 헤매지 않고 이어서 일하기 위한 문서다. 마지막 갱신 2026-09-18.
...
| Phase 3 ESP32 실습실 | `wf_86bbf998-bc6` | `workflows\scripts\phase3-esp32-lab-wf_86bbf998-bc6.js` | 2026-09-18 검토 단계 |
...
1. Claude에게 **"저장하고 정지"** — 커밋·push, `PROGRESS.md`·메모리 갱신, 정지 확인 메시지까지 받는다.
