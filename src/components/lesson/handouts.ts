 ...
 * 원본 PDF·PPTX는 올리지 않는다(PD-31, C6). 편집본은 얼굴·기관 경로·사적인 파일명·기기 주소·학급 게시물·표지 학교명을 가리고
 * 메타데이터를 지운 뒤 쪽마다 눈 확인 기록을 남긴 것만 둔다(PLAN §9.3 6번, P5-14). 저장소 검사의 허용 목록(scripts/repo-allowlist.yaml)에도 적어야 커밋된다.
 */
