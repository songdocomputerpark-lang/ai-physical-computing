...
//
//   :::더알아보기[MediaPipe의 다른 기능들]   ← 본문 줄기 밖의 참고 표·긴 설명을 접어 둔다(제목을 누르면 펼침). 발표 모드에서도 접힌 채 제목만 보인다
//
 ...
 * 차시마다 따로 적지 않아도 모든 탐구 과제에 같은 문장이 붙는다. 마지막 문장(개인정보를 AI에 보내지 않기)은 2026-09-25 Phase 5 검토(안전 4)에서
 * 더했다 — 웹캠 손동작처럼 화면 캡처(얼굴)를 붙여 넣기 쉬운 과제가 있어서다.
 */
export const GENAI_NOTE =
  '제출할 때 생성형 AI의 도움을 받은 부분을 표시해요. 예를 들어 AI에게 받은 문장이나 코드 옆에 "생성형 AI 도움"이라고 적어요. 이름·얼굴 사진·학교 정보 같은 개인정보는 AI에게 보내지 않아요.';
