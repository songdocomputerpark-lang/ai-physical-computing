 ...
 * ③ [예시 불러오기] 목록 — BlocksPanel.astro가 기본 예시 뒤에 이어 그리고, mode-ui.ts가 findPreset → findCommPreset 차례로 찾는다
 *   (presets.ts에 펼쳐 넣지 않는 까닭: 이 파일이 presets.ts를 import해서 순환 import가 된다. 2026-09-24 통합).
 */
