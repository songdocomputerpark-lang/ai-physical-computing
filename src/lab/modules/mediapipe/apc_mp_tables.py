"""얼굴·자세 연결표(MediaPipe 규격) — 이 파일은 scripts/gen-landmarks.mjs가 만든다 — 직접 고치지 말고 스크립트를 다시 돌린다.

출처: @mediapipe/tasks-vision 0.10.35의 FaceLandmarker.FACE_LANDMARKS_*·PoseLandmarker.POSE_CONNECTIONS를 그대로 옮겼다
...
FACEMESH_IRISES = frozenset([
    (474, 475), (475, 476), (476, 477), (477, 474), (469, 470), (470, 471),
    (471, 472), (472, 469),
])
